...
const Home = () => {
  ...
  const primaryColor = '#FC8019';      // Swiggy orange
  const primaryDark = '#E06B10';
  const primaryLight = '#FFA94D';
  const accentColor = '#FF4757';       // Zomato red accent for highlights
  ...
  const heroStyle = {
    marginTop: '32px',
    background: isDark
      ? `linear-gradient(135deg, rgba(252,128,25,0.12) 0%, rgba(252,128,25,0.06) 50%, rgba(255,71,87,0.08) 100%)`
      : `linear-gradient(135deg, rgba(252,128,25,0.08) 0%, rgba(252,128,25,0.04) 50%, rgba(255,71,87,0.04) 100%)`,
  ...
  const heroBadgeStyle = {
    ...
    alignItems: 'center',
    gap: '8px',
    backgroundColor: isDark ? 'rgba(252,128,25,0.15)' : 'rgba(252,128,25,0.08)',
    color: primaryColor,
    padding: '6px 16px',
    borderRadius: '999px',
    fontSize: '12px',
    fontWeight: '700',
    marginBottom: '20px',
    border: `1px solid ${isDark ? 'rgba(252,128,25,0.3)' : 'rgba(252,128,25,0.15)'}`,
    letterSpacing: '0.3px',
  };
          ...
          <div style={{ maxWidth: '680px', position: 'relative', zIndex: 2 }}>
            ...
            <h1 style={{
              ...
              Taste the <span style={{
                ...
                backgroundClip: 'text',
                color: 'transparent',
                textShadow: isDark ? '0 0 40px rgba(252,128,25,0.2)' : 'none',
              }}>Extraordinary</span>
            </h1>
            <p style={{
              fontSize: '18px',
              ...
              Order from top‑rated restaurants or let our Groq AI suggest dishes based on your mood – all in one place.
            </p>
            <div style={{ display: 'flex', gap: '16px', marginTop: '24px', flexWrap: 'wrap' }}>
              <div style={{
                ...
                <Star size={14} color={primaryColor} /> 4.5+ rated
              </div>
              <div style={{
                display: 'flex',
                alignItems: 'center',
                ...
                <Flame size={14} color={accentColor} /> 20 min delivery
              </div>
            </div>
          </div>
        </div>
