...
const getCardStyle = (isDark: boolean): React.CSSProperties => ({
  ...
  border: `1px solid ${isDark ? 'rgba(252,128,25,0.2)' : 'rgba(252,128,25,0.12)'}`,
      ...
      <div style={{ maxWidth: '1200px', margin: '0 auto', padding: '44px 28px 80px' }}>
        ...
        <div style={{ marginBottom: '40px' }}>
          <div style={{
            ...
            background: isDark ? 'rgba(252,128,25,0.2)' : 'rgba(252,128,25,0.12)',
            border: `1px solid ${isDark ? 'rgba(252,128,25,0.35)' : 'rgba(252,128,25,0.25)'}`,
            borderRadius: '999px', padding: '6px 18px', marginBottom: '16px',
            backdropFilter: 'blur(4px)',
            boxShadow: '0 2px 12px rgba(252,128,25,0.12)',
          }}>
            <Sparkles size={14} color="#FC8019" />
            <span style={{ fontSize: '11px', fontWeight: '800', color: '#FC8019', letterSpacing: '1px', textTransform: 'uppercase' }}>Powered by Groq AI</span>
          </div>
          <h1 style={{
          ...
          <p style={{ color: isDark ? '#94a3b8' : '#4A4A5A', fontSize: '15px', maxWidth: '560px' }}>
            Tell us how you feel and your preferences, and our Groq-powered assistant will suggest the perfect meal tailored just for you.
          </p>
        </div>
        ...
        <div style={{ display: 'flex', gap: '28px', flexWrap: 'wrap', alignItems: 'flex-start' }}>
          ...
          <div style={{ flex: '1.4 1 420px', display: 'flex', flexDirection: 'column', gap: '24px' }}>
            ...
            <div style={cardStyle}>
              <div style={{
                ...
                <div style={{
                  ...
                  background: 'linear-gradient(135deg, #FC8019, #E06B10)',
              ...
              <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '20px' }}>
                ...
                <div style={{ display: 'flex', gap: '16px', flexWrap: 'wrap' }}>
                  <div style={{ flex: '1 1 160px' }}>
                    ...
                    <select value={preference} onChange={(e) => setPreference(e.target.value)} style={inputStyle}
                      onFocus={(e) => { e.currentTarget.style.borderColor = '#FC8019'; e.currentTarget.style.boxShadow = '0 0 0 3px rgba(252,128,25,0.15)'; }}
                ...
                <div>
                  <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'baseline', marginBottom: '10px' }}>
                    ...
                    <span style={{
                      fontSize: '20px', fontWeight: '900', color: '#FC8019',
                      background: isDark ? 'rgba(252,128,25,0.12)' : 'rgba(252,128,25,0.08)',
                      border: `1px solid ${isDark ? 'rgba(252,128,25,0.25)' : 'rgba(252,128,25,0.2)'}`,
                  ...
                  <input
                    ...
                    style={{ width: '100%', cursor: 'pointer', accentColor: '#FC8019' }}
                  />
                ...
                <button type="submit" style={{
                  ...
                  boxShadow: '0 6px 28px rgba(252,128,25,0.4)',
                  letterSpacing: '0.2px',
                ...
                onMouseLeave={(e) => { e.currentTarget.style.transform = 'scale(1)'; e.currentTarget.style.boxShadow = '0 6px 28px rgba(252,128,25,0.4)'; }}>
                  <Sparkles size={18} />
            ...
            {recommendation && (
              <div style={{
                ...cardStyle,
                border: `1px solid ${isDark ? 'rgba(252,128,25,0.4)' : 'rgba(252,128,25,0.25)'}`,
                boxShadow: isDark
                  ? '0 16px 60px rgba(252,128,25,0.12), 0 0 0 1px rgba(252,128,25,0.1)'
                  : '0 16px 60px rgba(252,128,25,0.08), 0 0 0 1px rgba(252,128,25,0.08)',
                ...
                <div style={{
                  ...
                  background: `radial-gradient(circle, ${isDark ? 'rgba(252,128,25,0.15)' : 'rgba(252,128,25,0.08)'} 0%, transparent 70%)`,
                  pointerEvents: 'none',
                }} />
                <div style={{ display: 'flex', alignItems: 'center', gap: '12px', marginBottom: '20px' }}>
                  <div style={{
                    width: '42px', height: '42px', borderRadius: '14px',
                    background: isDark ? 'rgba(252,128,25,0.2)' : 'rgba(252,128,25,0.1)',
                    display: 'flex', alignItems: 'center', justifyContent: 'center',
                    border: `1px solid ${isDark ? 'rgba(252,128,25,0.3)' : 'rgba(252,128,25,0.2)'}`,
                  }}>
                    <Sparkles size={20} color="#FC8019" />
                  </div>
                  <div>
                    <div style={{ fontSize: '18px', fontWeight: '800', color: isDark ? '#fff' : '#1A1A2E' }}>AI Suggestion</div>
                    <div style={{ fontSize: '11px', color: '#FC8019', textTransform: 'uppercase', letterSpacing: '0.8px', fontWeight: '700' }}>Groq-powered result</div>
                  </div>
                </div>
                <div style={{
            ...
            <div style={{ ...cardStyle, maxHeight: '680px', display: 'flex', flexDirection: 'column' }}>
              <div style={{ display: 'flex', alignItems: 'center', gap: '12px', marginBottom: '20px', paddingBottom: '16px', borderBottom: `1px solid ${isDark ? 'rgba(255,255,255,0.06)' : 'rgba(0,0,0,0.06)'}` }}>
                <div style={{
                  ...
                  background: isDark ? 'rgba(252,128,25,0.15)' : 'rgba(252,128,25,0.08)',
                  display: 'flex', alignItems: 'center', justifyContent: 'center',
                  border: `1px solid ${isDark ? 'rgba(252,128,25,0.25)' : 'rgba(252,128,25,0.15)'}`,
                }}>
                  <History size={18} color="#FC8019" />
                </div>
                <div>
                ...
                <div style={{ display: 'flex', flexDirection: 'column', gap: '10px', overflowY: 'auto', flex: 1 }}>
                  {history.map((item: any) => (
                    <div
                      ...
                      onMouseEnter={(e) => {
                        (e.currentTarget as HTMLElement).style.background = isDark ? 'rgba(252,128,25,0.08)' : 'rgba(252,128,25,0.04)';
                        (e.currentTarget as HTMLElement).style.borderColor = isDark ? 'rgba(252,128,25,0.2)' : 'rgba(252,128,25,0.15)';
                      }}
                      onMouseLeave={(e) => {
                    ...
                    >
                      <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: '6px' }}>
                        <span style={{ fontSize: '12px', fontWeight: '800', color: '#FC8019' }}>{item.mood} Mood</span>
                        <span style={{ fontSize: '12px', fontWeight: '700', color: '#E06B10' }}>₹{item.budget}</span>
                      </div>
                      <p style={{
                      ...
                      <div style={{ display: 'flex', gap: '6px', marginTop: '8px', flexWrap: 'wrap' }}>
                        <span style={{ fontSize: '10px', background: isDark ? 'rgba(252,128,25,0.12)' : 'rgba(252,128,25,0.08)', border: `1px solid ${isDark ? 'rgba(252,128,25,0.2)' : 'rgba(252,128,25,0.15)'}`, color: '#FC8019', borderRadius: '6px', padding: '2px 7px', fontWeight: '700' }}>{item.cuisine}</span>
                        <span style={{ fontSize: '10px', background: isDark ? 'rgba(139,92,246,0.12)' : 'rgba(139,92,246,0.08)', border: `1px solid ${isDark ? 'rgba(139,92,246,0.2)' : 'rgba(139,92,246,0.15)'}`, color: '#8b5cf6', borderRadius: '6px', padding: '2px 7px', fontWeight: '700' }}>{item.foodType}</span>
                      </div>
