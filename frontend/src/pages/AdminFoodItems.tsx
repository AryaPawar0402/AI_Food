      ...
      <div style={{ maxWidth: '1300px', margin: '0 auto', padding: '44px 28px' }}>
        ...
        <div style={{ marginBottom: '40px' }}>
          <div style={{
            ...
            <Utensils size={14} color="#FC8019" />
            <span style={{ fontSize: '11px', fontWeight: '800', color: '#FC8019', letterSpacing: '1px', textTransform: 'uppercase' }}>Food Items</span>
          </div>
          <h1 style={{
            ...
            <div style={{
              ...
              <div style={{ position: 'relative', flex: '1 1 260px', minWidth: '200px' }}>
                <select
                  ...
                  onFocus={(e) => { e.currentTarget.style.borderColor = '#FC8019'; e.currentTarget.style.boxShadow = `0 0 0 3px rgba(252,128,25,0.2)`; }}
                    ...
                    {foodItems.length > 0 ? (
                      foodItems.map((item: any, idx: number) => (
                        <tr key={item._id} style={{
                          ...
                          <td style={{ padding: '14px 16px', fontWeight: '800', color: '#FC8019', fontSize: '15px' }}>₹{item.price}</td>
                          <td style={{ padding: '14px 16px' }}>
                            <span style={{ color: '#f59e0b', fontWeight: '700', fontSize: '14px' }}>★ {item.rating.toFixed(1)}</span>
                          </td>
                          <td style={{ padding: '14px 16px' }}>
                      ...
                      <tr>
                        <td colSpan={7} style={{ textAlign: 'center', padding: '60px 24px', color: isDark ? '#94a3b8' : '#9ca3af', fontSize: '15px' }}>
                          No dishes listed in this menu yet. Click <strong style={{ color: '#FC8019' }}>Add Food Item</strong> to begin.
                        </td>
                      </tr>
                    )}
                  </tbody>
                  ...
                  <button
                    ...
                    style={{
                      ...
                      background: generatingDesc
                        ? (isDark ? 'rgba(252,128,25,0.1)' : 'rgba(252,128,25,0.08)')
                        : (isDark ? 'rgba(252,128,25,0.2)' : 'rgba(252,128,25,0.12)'),
                      border: `1px solid ${isDark ? 'rgba(252,128,25,0.35)' : 'rgba(252,128,25,0.3)'}`,
