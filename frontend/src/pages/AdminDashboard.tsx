...
const AdminDashboard = () => {
  ...
  const sidebarGlass = {
    background: isDark
      ...
      : 'rgba(252,128,25,0.85)',
    backdropFilter: 'blur(20px)',
    WebkitBackdropFilter: 'blur(20px)',
    borderRight: `1px solid ${isDark ? 'rgba(252,128,25,0.3)' : 'rgba(255,255,255,0.25)'}`,
    boxShadow: isDark
      ? '0 20px 60px rgba(0,0,0,0.5), inset 0 1px 0 rgba(255,255,255,0.05)'
      : '0 20px 60px rgba(252,128,25,0.2), inset 0 1px 0 rgba(255,255,255,0.4)',
  };
          ...
          <div style={{ marginBottom: '40px', display: 'flex', alignItems: 'center', gap: '16px' }}>
            ...
            <div>
              <div style={{
                ...
                <LayoutDashboard size={14} color="#FC8019" />
                <span style={{ fontSize: '11px', fontWeight: '800', color: '#FC8019', letterSpacing: '1px', textTransform: 'uppercase' }}>Admin Panel</span>
              </div>
              <h1 style={{
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '28px' }}>
            ...
            <div style={{
              ...
              <div style={{
                ...
                borderRadius: '20px', padding: '26px 20px', textAlign: 'center',
                boxShadow: isDark
                  ? '0 10px 40px rgba(0,0,0,0.4), 0 0 0 1px rgba(252,128,25,0.2)'
                  : '0 10px 40px rgba(252,128,25,0.4)',
                borderTop: '4px solid #FFA94D',
                position: 'relative', overflow: 'hidden',
              }}>
                <div style={{
                  position: 'absolute', top: 0, right: 0, width: '80px', height: '80px',
                ...
                <DollarSign size={28} color={isDark ? '#FFA94D' : '#fff'} style={{ margin: '0 auto', display: 'block' }} />
                <div style={{ fontSize: '30px', fontWeight: '900', marginTop: '10px', color: isDark ? '#FFA94D' : '#fff', letterSpacing: '-1px' }}>
                  ₹{stats.totalRevenue}
                </div>
                <div style={{ fontSize: '11px', fontWeight: '700', textTransform: 'uppercase', letterSpacing: '0.8px', color: isDark ? 'rgba(255,169,77,0.7)' : 'rgba(255,255,255,0.8)', marginTop: '6px' }}>Total Revenue</div>
              </div>
            </div>
              ...
              <div style={{
                ...
                <div style={{ display: 'flex', alignItems: 'center', gap: '12px', marginBottom: '24px' }}>
                  <div style={{
                    ...
                    background: isDark ? 'rgba(252,128,25,0.2)' : 'linear-gradient(135deg, #FFF8F5, #FFE5CC)',
                    display: 'flex', alignItems: 'center', justifyContent: 'center',
                    border: `1px solid ${isDark ? 'rgba(252,128,25,0.3)' : 'rgba(252,128,25,0.2)'}`,
                  }}>
                    <TrendingUp size={18} color="#FC8019" />
                  </div>
                  <div>
                    ...
                    <svg viewBox="0 0 500 260" width="100%" height="240" style={{ minWidth: '380px' }}>
                      ...
                      <defs>
                        <linearGradient id="orangeBarGrad" x1="0" y1="0" x2="0" y2="1">
                          ...
                          <stop offset="100%" stopColor="#E06B10" />
                        </linearGradient>
                      </defs>
                    </svg>
                  </div>
              ...
              <div style={{
                ...
                <div style={{ display: 'flex', alignItems: 'center', gap: '12px', marginBottom: '24px' }}>
                  <div style={{
                    ...
                    <BarChart3 size={18} color="#FC8019" />
                  </div>
                  <div>
