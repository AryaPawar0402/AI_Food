      ...
      <div style={{ maxWidth: '1300px', margin: '0 auto', padding: '44px 28px' }}>
        ...
        <div style={{ marginBottom: '40px' }}>
          <div style={{
            ...
            <ShoppingBag size={14} color="#FC8019" />
            <span style={{ fontSize: '11px', fontWeight: '800', color: '#FC8019', letterSpacing: '1px', textTransform: 'uppercase' }}>Orders</span>
          </div>
          <h1 style={{
                          ...
                          <div style={{ display: 'flex', flexDirection: 'column', gap: '4px' }}>
                            {order.items.map((item: any, i: number) => (
                              <div key={i} style={{ fontSize: '12px', color: isDark ? '#cbd5e1' : '#374151' }}>
                                ...
                                <span style={{ fontWeight: '800', color: '#FC8019' }}>×{item.quantity}</span>
                              </div>
                            ))}
                          </div>
                        </td>
                        <td style={{ padding: '16px', whiteSpace: 'nowrap' }}>
                          <span style={{ fontSize: '16px', fontWeight: '800', color: '#FC8019' }}>₹{order.totalAmount}</span>
                        </td>
