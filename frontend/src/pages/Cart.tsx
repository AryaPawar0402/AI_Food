...
const getCardStyle = (isDark: boolean): React.CSSProperties => ({
  ...
  borderRadius: '20px',
  padding: '20px',
  border: `1px solid ${isDark ? 'rgba(252,128,25,0.12)' : 'rgba(252,128,25,0.08)'}`,
  boxShadow: isDark ? '0 8px 32px rgba(0,0,0,0.3)' : '0 8px 32px rgba(252,128,25,0.06)',
  display: 'flex',
  alignItems: 'center',
  gap: '18px',
...
const Cart = () => {
  ...
  const primaryGrad = 'linear-gradient(135deg, #FC8019, #E06B10)';
  const primaryShadow = '0 6px 24px rgba(252,128,25,0.4)';
      ...
      <div style={getBg(isDark)}>
        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', minHeight: '100vh' }}>
          <div style={{
            ...
            borderRadius: '28px', border: `1px solid ${isDark ? 'rgba(252,128,25,0.2)' : 'rgba(252,128,25,0.12)'}`,
            boxShadow: isDark ? '0 40px 80px rgba(0,0,0,0.5)' : '0 20px 60px rgba(252,128,25,0.06)',
            maxWidth: '420px',
          }}>
            <div style={{
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 360px', gap: '28px', alignItems: 'flex-start' }}>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
                ...
                return (
                  <div key={item._id} style={getCardStyle(isDark)}
                    ...
                    <div style={{ flex: 1, minWidth: '140px' }}>
                      ...
                      <p style={{ fontSize: '12px', color: '#FC8019', fontWeight: '600' }}>from {food.restaurantId?.name || 'Restaurant'}</p>
                    ...
                    <div style={{ textAlign: 'right', minWidth: '80px' }}>
                      <span style={{ fontSize: '18px', fontWeight: '900', color: '#FC8019' }}>₹{food.price * item.quantity}</span>
                    </div>

                    {/* Remove */}
                    <button
                      onClick={() => handleRemove(food._id)}
                      style={{ width: '36px', height: '36px', borderRadius: '10px', border: '1px solid rgba(239,68,68,0.25)', background: 'rgba(239,68,68,0.1)', cursor: 'pointer', color: '#ef4444', display: 'flex', alignItems: 'center', justifyContent: 'center', flexShrink: 0 }}
              ...
              <Link to="/" style={{
                ...
                background: isDark ? 'rgba(255,255,255,0.06)' : 'rgba(252,128,25,0.06)',
                border: `1px solid ${isDark ? 'rgba(255,255,255,0.1)' : 'rgba(252,128,25,0.15)'}`,
                color: isDark ? 'rgba(255,255,255,0.6)' : '#FC8019',
            ...
            <div style={{
              ...
              border: `1px solid ${isDark ? 'rgba(252,128,25,0.2)' : 'rgba(252,128,25,0.1)'}`,
              ...
              <div style={{
                ...
                borderRadius: '16px', border: `1px solid ${isDark ? 'rgba(252,128,25,0.25)' : 'rgba(252,128,25,0.15)'}`,
                display: 'flex', justifyContent: 'space-between', alignItems: 'center',
              }}>
                <span style={{ fontSize: '16px', fontWeight: '800', color: isDark ? '#fff' : '#1A1A2E' }}>Total To Pay</span>
                <span style={{ fontSize: '24px', fontWeight: '900', color: '#FC8019' }}>₹{grandTotal}</span>
              </div>
              ...
              <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '6px', marginTop: '14px' }}>
                <Shield size={12} color="rgba(252,128,25,0.6)" />
