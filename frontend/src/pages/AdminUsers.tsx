      ...
      <div style={{ maxWidth: '1300px', margin: '0 auto', padding: '44px 28px' }}>
        ...
        <div style={{ marginBottom: '40px' }}>
          <div style={{
            ...
            <Users size={14} color="#FC8019" />
            <span style={{ fontSize: '11px', fontWeight: '800', color: '#FC8019', letterSpacing: '1px', textTransform: 'uppercase' }}>Users</span>
          </div>
          <h1 style={{
                    ...
                    return (
                      <div key={item.month}>
                        <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: '4px' }}>
                          ...
                          <span style={{ fontSize: '13px', fontWeight: '700', color: '#FC8019' }}>{item.count} user{item.count !== 1 ? 's' : ''}</span>
                        </div>
                        <div style={{ height: '8px', borderRadius: '999px', background: isDark ? 'rgba(255,255,255,0.05)' : '#f3f4f6', overflow: 'hidden' }}>
                          <div style={{
                            ...
                            background: 'linear-gradient(90deg, #FC8019, #FFA94D)',
