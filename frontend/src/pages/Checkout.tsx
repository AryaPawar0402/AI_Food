...
const Checkout = () => {
  ...
  const primaryDark = '#E06B10';
  const primaryGrad = `linear-gradient(135deg, ${primaryColor}, ${primaryDark})`;
  const primaryShadow = `0 6px 28px rgba(252,128,25,0.4)`;
    ...
    <div style={getBg(isDark)}>
      <div style={{ maxWidth: '1100px', margin: '0 auto', padding: '44px 28px 80px' }}>
            ...
            <React.Fragment key={step.label}>
              <div style={{ display: 'flex', alignItems: 'center', gap: '6px' }}>
                <div style={{
                  ...
                  boxShadow: step.done || i === 1 ? `0 2px 10px rgba(252,128,25,0.4)` : 'none',
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 360px', gap: '28px', alignItems: 'flex-start' }}>
            ...
            <div style={cardStyle}>
              ...
              <label style={{
                ...
                background: paymentMethod === 'COD'
                  ? (isDark ? 'rgba(252,128,25,0.1)' : 'rgba(252,128,25,0.06)')
                  : (isDark ? 'rgba(255,255,255,0.04)' : 'rgba(0,0,0,0.02)'),
                border: paymentMethod === 'COD'
                  ? `1.5px solid ${isDark ? 'rgba(252,128,25,0.5)' : 'rgba(252,128,25,0.4)'}`
              ...
              <div style={{
                ...
                border: `1.5px solid ${isDark ? 'rgba(255,255,255,0.05)' : 'rgba(0,0,0,0.04)'}`,
                opacity: 0.45, cursor: 'not-allowed',
              }}>
                <input type="radio" name="paymentMethod" value="ONLINE" disabled style={{ width: '16px', height: '16px' }} />
                <div>
                  <div style={{ fontWeight: '700', color: isDark ? '#fff' : '#1A1A2E', fontSize: '14px' }}>Online UPI / Cards</div>
                  <div style={{ fontSize: '12px', color: isDark ? 'rgba(255,255,255,0.4)' : 'rgba(0,0,0,0.4)', marginTop: '2px' }}>Net Banking, Credit/Debit cards, wallets — Coming soon.</div>
                </div>
                <span style={{
                  ...
                  borderRadius: '6px', padding: '2px 8px', letterSpacing: '0.5px', whiteSpace: 'nowrap',
                }}>SOON</span>
              </div>
            </div>
          </form>
          ...
          <div style={{
            ...cardStyle,
            border: `1px solid ${isDark ? 'rgba(252,128,25,0.2)' : 'rgba(252,128,25,0.08)'}`,
            ...
            <button
              ...
              onMouseEnter={(e) => {
                ...
                e.currentTarget.style.boxShadow = '0 8px 36px rgba(252,128,25,0.55)';
              }}
              onMouseLeave={(e) => {
