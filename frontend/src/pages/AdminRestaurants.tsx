      ...
      <div style={{ maxWidth: '1300px', margin: '0 auto', padding: '44px 28px' }}>
        ...
        <div style={{ marginBottom: '40px' }}>
          <div style={{
            ...
            <Store size={14} color="#FC8019" />
            <span style={{ fontSize: '11px', fontWeight: '800', color: '#FC8019', letterSpacing: '1px', textTransform: 'uppercase' }}>Restaurants</span>
          </div>
          <h1 style={{
        ...
        <div style={{ display: 'flex', gap: '28px', flexWrap: 'wrap', alignItems: 'flex-start' }}>
          ...
          <aside style={{
            ...
            border: `1px solid ${isDark ? 'rgba(252,128,25,0.3)' : 'rgba(255,255,255,0.2)'}`,
            boxShadow: isDark
              ? '0 20px 60px rgba(0,0,0,0.4), inset 0 1px 0 rgba(255,255,255,0.05)'
              : '0 20px 60px rgba(252,128,25,0.3), inset 0 1px 0 rgba(255,255,255,0.2)',
          ...
          <main style={{ flex: 1, minWidth: 0 }}>
            ...
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '24px', flexWrap: 'wrap', gap: '12px' }}>
              ...
              <button onClick={handleOpenAdd} style={{
                ...
                cursor: 'pointer', boxShadow: '0 4px 20px rgba(252,128,25,0.4)',
            ...
            {totalRestaurants > 0 && chartData.length > 0 && (
              <div style={{
                ...
                <div style={{ display: 'flex', alignItems: 'center', gap: '12px', marginBottom: '16px' }}>
                  <BarChart3 size={20} color="#FC8019" />
                    ...
                    return (
                      <div key={item.cuisine}>
                        <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: '4px' }}>
                          ...
                          <span style={{ fontSize: '13px', fontWeight: '700', color: '#FC8019' }}>{item.count} ({percentage.toFixed(1)}%)</span>
                        </div>
            ...
            <div style={{
              ...
              border: `1px solid ${isDark ? 'rgba(252,128,25,0.15)' : 'rgba(252,128,25,0.1)'}`,
            }}>
              <div style={{ overflowX: 'auto' }}>
                <table style={{ width: '100%', borderCollapse: 'collapse' }}>
                  <thead>
                    <tr style={{
                      background: isDark ? 'rgba(252,128,25,0.15)' : 'linear-gradient(135deg, #FFF8F5, #FFE5CC)',
                      borderBottom: `2px solid ${isDark ? 'rgba(252,128,25,0.2)' : 'rgba(252,128,25,0.2)'}`,
                    }}>
                  ...
                  <tbody>
                    {restaurants.length > 0 ? restaurants.map((rest: any, idx: number) => (
                      <tr key={rest._id} style={{
                        ...
                        <td style={{ padding: '14px 16px' }}>
                          <span style={{
                            background: isDark ? 'rgba(252,128,25,0.12)' : '#FFF8F5',
                            borderRadius: '8px', padding: '4px 10px',
                            fontSize: '12px', fontWeight: '600',
                            color: isDark ? '#FFA94D' : '#E06B10',
                            border: `1px solid ${isDark ? 'rgba(252,128,25,0.2)' : 'rgba(252,128,25,0.2)'}`,
                          }}>{rest.cuisine}</span>
                        </td>
                        <td style={{ padding: '14px 16px' }}>
                          <span style={{ color: '#f59e0b', fontWeight: '800', fontSize: '14px' }}>★ {rest.rating.toFixed(1)}</span>
                        </td>
                        <td style={{ padding: '14px 16px' }}>
                        ...
                        <td style={{ padding: '14px 16px' }}>
                          <span style={{ display: 'inline-flex', alignItems: 'center', gap: '4px', fontSize: '13px', fontWeight: '600', color: isDark ? '#cbd5e1' : '#374151' }}>
                            <span style={{ width: '6px', height: '6px', borderRadius: '50%', background: '#FC8019', display: 'inline-block' }} />
                        ...
                        <td style={{ padding: '14px 16px' }}>
                          <div style={{ display: 'flex', gap: '8px' }}>
                            <button onClick={() => handleOpenEdit(rest)} title="Edit Restaurant" style={{
                              ...
                              cursor: 'pointer', color: isDark ? '#60a5fa' : '#3b82f6',
                            }}>
                              <Edit2 size={14} />
                            </button>
                            <button onClick={() => handleDelete(rest._id)} title="Delete Restaurant" style={{
                              ...
                              cursor: 'pointer', color: isDark ? '#f87171' : '#ef4444',
                            }}>
                              <Trash2 size={14} />
                            </button>
                          </div>
                      ...
                      <tr>
                        <td colSpan={7} style={{ textAlign: 'center', padding: '80px 24px' }}>
                          <Store size={40} color={isDark ? '#475569' : '#d1d5db'} style={{ margin: '0 auto 12px', display: 'block' }} />
                          <p style={{ color: isDark ? '#94a3b8' : '#9ca3af', fontSize: '15px', fontWeight: '600' }}>
                            No restaurants found. Click <strong style={{ color: '#FC8019' }}>Add Restaurant</strong> to create one.
                          </p>
                        </td>
                      </tr>
                    )}
        ...
        <div style={modalOverlay(isDark)}>
          <div style={{
            ...
            <div style={{
              ...
              borderBottom: `1px solid ${isDark ? 'rgba(252,128,25,0.15)' : 'rgba(252,128,25,0.1)'}`,
            }}>
              <div>
            ...
            <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
              ...
              <button type="submit" style={{
                ...
                cursor: 'pointer', boxShadow: '0 6px 24px rgba(252,128,25,0.4)',
                letterSpacing: '0.2px',
                transition: 'transform 0.2s, box-shadow 0.2s',
              }}
              onMouseEnter={(e) => { e.currentTarget.style.transform = 'scale(1.01)'; e.currentTarget.style.boxShadow = '0 8px 32px rgba(252,128,25,0.55)'; }}
              onMouseLeave={(e) => { e.currentTarget.style.transform = 'scale(1)'; e.currentTarget.style.boxShadow = '0 6px 24px rgba(252,128,25,0.4)'; }}>
